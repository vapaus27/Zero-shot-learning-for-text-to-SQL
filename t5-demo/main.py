...
config = T5Config.from_pretrained("/data0/anning/pretrained/t5-base-finetuned-wikiSQL/")
tokenizer = T5Tokenizer.from_pretrained("/data0/anning/pretrained/t5-base-finetuned-wikiSQL/")
model = T5ForConditionalGeneration.from_pretrained(
    "/data0/anning/pretrained/t5-base-finetuned-wikiSQL/")
